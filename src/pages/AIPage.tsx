...
export default function AIPage() {
  ...
  useGSAP(() => {
    ...
    const chatTl = gsap.timeline({
      scrollTrigger: { trigger: '.chat-section', start: 'top 70%', end: 'top 10%', scrub: 1 },
    });
    ...
    <div ref={containerRef}>
      ...
      <section className="pb-24 md:pb-32 px-6">
        <div className="privacy-card mx-auto max-w-3xl section-surface rounded-3xl p-10 md:p-14 text-center relative overflow-hidden">
          ...
          <p className="text-text-secondary text-lg leading-relaxed max-w-xl mx-auto mb-8">{t('pages.ai.privacy_desc')}</p>
          <Link to="/ollama" className="inline-flex items-center gap-2 text-sm text-accent hover:text-white transition-colors duration-200">
