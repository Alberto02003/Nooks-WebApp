...
const socials = [
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/nooksapp',
  ...
  {
    name: 'TikTok',
    href: 'https://tiktok.com/@nooksapp',
  ...
  {
    name: 'Facebook',
    href: 'https://facebook.com/nooksapp',
          ...
          <div className="flex items-center gap-3">
            {socials.map((s) => (
              <a key={s.name} href={s.href} target="_blank" rel="noopener noreferrer" aria-label={s.name}
                className="w-9 h-9 rounded-full flex items-center justify-center text-text-muted hover:text-white hover:bg-white/[0.06] transition-all duration-200">
                {s.icon}
              </a>
            ))}
          </div>
